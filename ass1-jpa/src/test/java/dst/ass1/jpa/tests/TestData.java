...
public class TestData implements ITestData {
    ...
    public static final String PREFERENCES_1_KEY_1 = "key11";
    public static final String PREFERENCES_1_VALUE_1 = "preference11";
    public static final String PREFERENCES_1_KEY_2 = "key12";
    public static final String PREFERENCES_1_VALUE_2 = "preference12";
    public static final String PREFERENCES_2_KEY_1 = "key21";
    public static final String PREFERENCES_2_VALUE_1 = "preference21";
    ...
    public Long preferences1Id;
    public Long preferences2Id;
    public Long preferences3Id;
    public Long preferences4Id;
    ...
    public void insert(IModelFactory modelFactory, EntityManager em) {
        ...
        //Preferences
        IPreferences preferences1 = modelFactory.createPreferences();
        IPreferences preferences2 = modelFactory.createPreferences();
        IPreferences preferences3 = modelFactory.createPreferences();
        IPreferences preferences4 = modelFactory.createPreferences();

        preferences1.putData(PREFERENCES_1_KEY_1, PREFERENCES_1_VALUE_1);
        preferences1.putData(PREFERENCES_1_KEY_2, PREFERENCES_1_VALUE_2);
        preferences2.putData(PREFERENCES_2_KEY_1, PREFERENCES_2_VALUE_1);
        ...
        rider1.setPreferences(preferences1);
        rider2.setPreferences(preferences2);
        rider3.setPreferences(preferences3);
        rider4.setPreferences(preferences4);
        ...
        employmentKey13.setDriver(driver5);
        ...
        employment5.setSince(localDateToDate(LocalDate.now().minusDays(2)));
        ...
        Date oneMonthAndDayAgo = localDateToDate(LocalDate.now().minusDays(32));
        employment8.setSince(oneMonthAndDayAgo);
        employment8.setId(employmentKey8);

        employment9.setActive(true);
        employment9.setSince(oneMonthAndDayAgo);
        employment9.setId(employmentKey9);

        employment10.setActive(true);
        employment10.setSince(localDateToDate(LocalDate.now().minusDays(2)));
        employment10.setId(employmentKey10);

        employment11.setActive(true);
        employment11.setSince(localDateToDate(LocalDate.now().minusDays(2)));
        employment11.setId(employmentKey11);

        employment12.setActive(true);
        employment12.setSince(localDateToDate(LocalDate.now().minusDays(2)));
        employment12.setId(employmentKey12);

        employment13.setActive(true);
        employment13.setSince(localDateToDate(LocalDate.now().minusDays(2)));
        ...
        em.persist(preferences1);
        em.persist(preferences2);
        em.persist(preferences3);
        em.persist(preferences4);
        em.persist(rider1);
        em.persist(rider2);
        em.persist(rider3);
        em.persist(rider4);
        ...
        preferences1Id = preferences1.getId();
        preferences2Id = preferences2.getId();
        preferences3Id = preferences3.getId();
        preferences4Id = preferences4.getId();
